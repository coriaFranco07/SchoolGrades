...
<body>
    ...
    <div class="container">
        ...
        <form action="insertarProfesor2.php" method="POST" align="center">
            ...
            <a href="profesores.php" class="btn btn-outline-light btn-lg btn-block mb-4" style="background-color: #1f2735; border-radius: 15px;">Volver</a>
        </form>
    </div>
</body>
</html>