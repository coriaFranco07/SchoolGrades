...
<body>
    <div class="container">
        ...
        <br>
        <button type="button" class="btn btn-primary" onclick="window.location.href='insertarcursoProfe.php'">Agregar Profe a Curso</button>
        ...
        $sql = "SELECT p.id_cp, s.id_profesor, e.id_curso, x.id_estado, s.nombre, s.apellido AS profesores , e.tipo AS curso, x.tipo AS estado
        FROM curso_profe p
        ...
        <table id="cursosProfes" class="table table-bordered table-striped text-center">
            <thead>
                <tr class="bg-primary text-white">
                    <th scope="col">ID_CURSO/PROFE</th>
            ...
            <tbody>
                ...
                while ($mostrar = mysqli_fetch_array($result)) {
                    ?>
                    <tr>
                        <td><?php echo $mostrar['id_cp'] ?></td>
                        <td><?php echo $mostrar['nombre'] ?></td>
                        <td><?php echo $mostrar['profesores'] ?></td>
                        <td><?php echo $mostrar['curso'] ?></td>
                        <td><?php echo $mostrar['estado'] ?></td>
                        <td>
                            <button type="button" class="btn btn-warning" onclick="window.location.href='estadoCursoProfe.php?id=<?php echo $mostrar["id_cp"]; ?>'">Estado</button>
                        </td>
                    </tr>
                <?php
                }
