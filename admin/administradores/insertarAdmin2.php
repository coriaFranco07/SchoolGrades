...
if (
    ...
    $verificar_correo_sql = "SELECT correo FROM administradores WHERE correo = ?";
    ...
    if (mysqli_stmt_num_rows($verificar_correo_stmt) > 0) {
        ...
        $sql = "INSERT INTO administradores (nombre, apellido, correo, usuario, contraseña, id_sexo, id_estado) VALUES (?, ?, ?, ?, ?, ?, ?)";
