...
<body>
    <div class="container">
        ...
        <button type="button" class="btn btn-dark" onclick="window.location.href='notasAlumnosHistorial.php?idCurso=<?php echo $_GET['idCurso']; ?>&cursoNombre=<?php echo urlencode($_GET['cursoNombre']); ?>'">Historial Notas</button>
        <button type="button" class="btn btn-dark" onclick="window.location.href='notasCursos.php'">Cancelar</button>
            ...
            <tbody>
                ...
                while ($mostrar = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td> 
                        <button type="button" class="btn btn-info" onclick="window.location.href='editarNotas.php?id=<?php echo $mostrar["id_calificacion"]; ?>&idCurso=<?php echo $idCurso; ?>&cursoNombre=<?php echo $cursoNombre; ?>'">Editar</button>
                        <button type="button" class="btn btn-danger" onclick="window.location.href='eliminarNotas.php?id=<?php echo $mostrar["id_calificacion"]; ?>&idCurso=<?php echo $idCurso; ?>&cursoNombre=<?php echo $cursoNombre; ?>'">Eliminar</button>
                        </td>
                    </tr>
                <?php
                }
