...
<body>
    <div class="container">
        ...
        $sql = "SELECT p.id_cm, x.tipo , s.tipo AS materia 
            ...
            <tbody>
                ...
                while ($mostrar = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td> 
                        <button type="button" class="btn btn-warning" onclick="window.location.href='estadoMateriaCurso2.php?id=<?php echo $mostrar["id_cm"]; ?>'">Cambiar estado</button>
